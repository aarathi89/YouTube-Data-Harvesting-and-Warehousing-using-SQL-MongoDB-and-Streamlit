...
uri = "mongodb+srv://aarathi:12345@cluster0.nggype5.mongodb.net/?retryWrites=true&w=majority"
...
api_key = "AIzaSyBFUiDUGvbs-_t4bur3K5fotlJnSJludss"
...
if selected == "Home":
    # Title Image
    st.image("YouTube-Logo.png",width=100)
    #col1,col2 = st.columns(2,gap= 'medium')
    st.header("# YouTube_Data_Harvesting")
    st.title("## :blue[Domain] : Social Media")
    st.header("## :blue[Technologies used] : Python,MongoDB, Youtube Data API, MySql, Streamlit")
...
if selected == "Extract & Transform":
    ...
    with tab2:     
        ...
        #st.write('You selected:', user_inp)
        ...
        def insert_into_channels():
                ...
                for i in collections.find({"Channel_name" : user_inp},{'_id' : 0}):
                    mycursor.execute(query,('julia fei','UUm4RlxY2d-bFljXyhrkX5Tg','112000','7301175',))
                    mydb.commit()
